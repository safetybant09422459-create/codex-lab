...
4. `docs/architecture.md`、`docs/runtime.md`、`docs/skill_standard_architecture.md`、`docs/decisions/2026-07-domain-provider-boundary.md`、関連する `docs/decisions/`。責務と採用済み判断を確認する。

...
- Chat Core v0.3 Response Intelligence / Travel Answer Generator v0.1（[設計と実装準備](docs/chat_response_intelligence.md)）
- Confirmation UI
...
次フェーズの「Tool結果を表示するだけでなく、質問へ直接答える」設計、Effort Policy、
Travel Answer Generator v0.1の配置案は

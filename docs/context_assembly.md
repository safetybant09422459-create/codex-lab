...
現在の`POST /api/chat`はこのAssemblyを持たず、最大5TurnのWorking ContextとTravel専用promptだけを
Travel Plannerへ渡す。Current World、Capability Catalog、Memory RAG、共通Turn契約は未実装である。

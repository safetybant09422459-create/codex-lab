...
Spot代表画像は、TravelのSpotを見やすくするための画像である。
...
Spot代表画像は、訪問前にも必要になる。

訪問前には、まだ家族写真は存在しない。

そのため、Spot代表画像はTravelのSpot表示の一部として扱い、画像取得とキャッシュはGoogle Places Adapterに委譲する。

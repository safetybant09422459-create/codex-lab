...
8. expected、actual、候補、質問、Reason Traceから失敗のRoot Causeを固定ルールで分類する。
9. Skill別のLayer Summary、Root Cause Summary、Improvement Opportunities、Executive Summaryを含むJSON／Markdown reportを出力する。
10. 必要に応じて結果全体をbaselineとして保存し、過去結果との差分とRegressionを検出する。
